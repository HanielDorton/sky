package com.haniel.game.android;
...
public class AndroidLauncher extends AndroidApplication implements ActionResolver{
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		initialize(new Sky(this), config);
	}
	...
	public void submitScoreGPGS(float score) {
		Games.Leaderboards.submitScore(_gameHelper.getApiClient(), "CgkI4qvY37UcEAIQBg", (long) score);		
	}
	...
	public void getLeaderboardGPGS() {
		if (_gameHelper.isSignedIn()) {
			startActivityForResult(Games.Leaderboards.getLeaderboardIntent(_gameHelper.getApiClient(), "CgkI4qvY37UcEAIQBg"), 100);
			}
